# Usability Report: Evaluación del Diseño B (Rakuin Ramen)
...
El estudio se llevó a cabo mediante un diseño A/B testing inter-sujetos con una muestra total de 10 participantes, de los cuales 5 evaluaron exclusivamente el prototipo interactivo de Rakuin Ramen (Caso B) desplegado en Figma.
...
Para la prueba de seguimiento ocular se empleó la herramienta Gaze Recorder sobre las pantallas estáticas de la página de Inicio y la Carta, analizando la fijación visual de los usuarios en intervalos de 15 segundos.
